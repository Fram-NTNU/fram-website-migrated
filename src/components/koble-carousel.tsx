...
export function KobleCarousel() {
  ...
  return <div id="kobCar" className="relative aspect-[4/3] overflow-hidden rounded-[3px] shadow-[0_32px_64px_rgba(0,0,0,.45)] max-[760px]:aspect-video max-[760px]:max-h-[260px]">

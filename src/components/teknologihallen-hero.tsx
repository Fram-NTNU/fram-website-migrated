      ...
      <div className="absolute inset-0 z-[2] flex items-end bg-[linear-gradient(to_top,rgba(18,25,30,.92)_0%,rgba(18,25,30,.5)_46%,rgba(18,25,30,.1)_80%)] pb-[54px]">
        <div className="mx-auto w-full max-w-[1360px] px-12 max-[720px]:px-[22px]">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a href="#organisasjoner" className="inline-flex items-center gap-2.5 rounded-[3px] border-2 border-transparent bg-white px-[26px] py-3.5 text-[15px] font-bold text-[var(--steel)] no-underline [transition:transform_.2s,box-shadow_.2s] hover:[transform:translateY(-3px)] hover:shadow-[0_6px_0_var(--accent)]">Utforsk organisasjonene →</a>
            <a href="#bak-teknologihallen" className="inline-flex items-center gap-2.5 rounded-[3px] border-2 border-white/45 bg-white/5 px-[26px] py-3.5 text-[15px] font-bold text-white no-underline [transition:transform_.2s,border-color_.2s,background_.2s] hover:border-white hover:bg-white/12 max-[560px]:hidden">Søk om plass</a>
          </div>
        </div>
      </div>

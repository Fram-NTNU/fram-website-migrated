...
function EventCard({ event }: { event: EventItem }) {
  ...
  return <article style={style} className="ev-card flex flex-col overflow-hidden rounded-[3px] border border-[var(--line)] bg-[var(--card)] text-[var(--ink)] [transition:transform_.25s_ease,box-shadow_.25s_ease] hover:[transform:translateY(-4px)] hover:shadow-[0_16px_40px_rgba(30,30,30,.08)]">
...
function SkeletonCard() {
  return <article aria-hidden="true" className="flex flex-col overflow-hidden rounded-[3px] border border-[var(--line)] bg-[var(--card)]">

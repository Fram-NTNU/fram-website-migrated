          ...
          <div className="mb-7 flex flex-wrap items-start justify-between gap-10 border-b border-[var(--line)] pb-7">
            ...
            <div className="flex flex-col gap-3 max-[620px]:w-full">
              ...
              <div className="flex flex-col items-start gap-[18px] max-[620px]:flex-row max-[620px]:items-center max-[620px]:gap-5">
                ...
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img width="550" height="157" loading="lazy" decoding="async" src={sparebankWhite ? "/assets/sparebank1-smn-neg.webp" : "/assets/sparebank1SMNhvit.png"} alt="SpareBank 1 SMN" className={`-ml-2 h-9 w-auto max-[620px]:h-5 ${sparebankWhite ? "" : logoFilter}`} />
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img width="500" height="198" loading="lazy" decoding="async" src="/assets/partners/equinor.webp" alt="Equinor" className={`h-[34px] w-auto max-[620px]:h-5 ${logoFilter}`} />
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img width="500" height="344" loading="lazy" decoding="async" src="/assets/DNB_Logo.png" alt="DNB" className={`mt-4 h-[30px] w-auto max-[620px]:mt-0 max-[620px]:h-5 ${logoFilter}`} />
              </div>
            </div>

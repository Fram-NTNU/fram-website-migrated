            ...
            <div className="mb-[60px] grid min-h-[calc(100vh-130px)] grid-cols-[.78fr_1.22fr] items-center gap-8 max-[900px]:min-h-0 max-[900px]:grid-cols-1 max-[900px]:gap-6 max-[599px]:mb-8">
              ...
              <div className="flex min-w-0 items-center justify-end overflow-visible max-[900px]:hidden">
                <img
                  ...
                  width="1280"
                  height="812"
                  className="mr-[-2%] block h-auto w-full max-w-[720px] drop-shadow-[0_26px_46px_rgba(20,30,50,.14)]"
                />
              </div>
            </div>
        ...
        >
          <div className={wrap}>
            <div className="mb-[42px] flex flex-wrap items-end justify-between gap-x-8 gap-y-5">
              ...
              <Link
                href="/arrangementer"
                className="inline-flex items-center gap-2 rounded-[3px] border border-white/35 px-5 py-2.5 text-[13px] font-semibold text-[var(--bg)] no-underline [transition:background_.2s,border-color_.2s] hover:border-white/60 hover:bg-white/[.06]"
              >
            ...
            <div className="grid grid-cols-[1fr_1.3fr] items-stretch gap-6 max-[900px]:grid-cols-1">
              ...
              <article className="group order-2 flex flex-col overflow-hidden border-y-2 border-white/35">
